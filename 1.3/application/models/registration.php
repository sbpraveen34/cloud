...
<html>
    <head>
        ...
        <title>Password Activation Mail</title>
		<style type="text/css">
			...
			* @tip Set the background color for your email. You may want to choose one that matches your company branding.
			* @theme page
			*/
                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            	...
                                            	<img src="https://lh5.ggpht.com/d_aU4ZPCzhF0E-wd_bPgTxPkdQ_oR9eeZt0ECd6vo1uvtrGeoI9Jlw3IK-zOTa75Muk=w705" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Smart SMS Mobile Application</h1>
                                                                
                                                               
                                                                <h4 class="h4">Password Activation</h4>
                                                                <strong>Password For Your Smart SMS Mobile Application:</strong>'.$data['password'] .'
                                                                <br />
                                                                <br />
