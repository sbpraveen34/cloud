...
public function userlogin()                          ///userlogin() is the api used to do login 
{
	...
	{
		if($this->input->post('format')=="json" && $this->input->post('datatype')=="history")///checks the correctness of the all the parameters
		{
...
public function userregistration()
{
	...
	{
		if($this->input->post('format')=="json" && $this->input->post('datatype')=="history")
		{
...
{
	if(isset($_POST['data']) && isset($_POST['format']) && isset($_POST['datatype']) && isset($_POST['noofdata']))
	{
		if($this->input->post('format')=="json" && $this->input->post('datatype')=="history")
		{
			...
			for ($i=0;$i<$TotalData;$i++)
			{
				...
				$this->history->addrawHistory($Data[$i],$_POST['email']);
			}
		}
		else 
		{
